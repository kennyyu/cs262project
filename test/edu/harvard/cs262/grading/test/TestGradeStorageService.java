...
public class TestGradeStorageService {
	...
	public void testAssignment() throws Exception {
		...
		Submission sub1 = new SubmissionImpl(new StudentImpl(0), new AssignmentImpl(), content);
		
		//Oh no, they submitted the same assignment! Plagiarism!
		Submission sub2 = new SubmissionImpl(new StudentImpl(1), new AssignmentImpl(), content);
		...
		Grade grade2 = new GradeImpl(new ScoreImpl(50, 100), grader2, "This sucks!");
