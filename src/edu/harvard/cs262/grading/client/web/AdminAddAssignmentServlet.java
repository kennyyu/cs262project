...
public class AdminAddAssignmentServlet extends HttpServlet {
	...
	public void lookupServices() {
        ...
        try {
        	...
        	assignmentService = (AssignmentServiceServer) ServiceLookupUtility.lookupService(new ServletConfigReader(this.getServletContext()), "AssignmentService");
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
    	...
    	String rawAssignmentDescription = request.getParameter("assignmentDescription");
    	...
    	if(rawAssignmentID == null || rawAssignmentDescription == null) {
	    	...
	    	try{
		    	...
		    	assignmentService.addNewAssignment(assignmentID, rawAssignmentDescription);
