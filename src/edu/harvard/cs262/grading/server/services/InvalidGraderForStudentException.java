...
public class InvalidGraderForStudentException extends Exception {
	...
	public InvalidGraderForStudentException(Student grader, Student submitter, Shard shard) {
		super("Student " + grader + " is not allowed to grade student " + submitter + " for this sharding: " + shard);
	}
